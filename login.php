        ...
        if ($row) {
            ...
            if (password_verify($pass, $row['upass'])) {
                ...
                if ($row['status'] == 'approved') {
                    ...
                    $msg = "<p class='alert alert-info'>Your account is pending approval. Please wait for admin approval.</p>";
                } elseif ($row['status'] == 'disapproved') {
                    $msg = "<p class='alert alert-warning'>Your account has been disapproved by the admin. Please contact support.</p>";
                }
            } else {
